...
class PermissionAspectTest {
    ...
    void check_whenPermissionGranted_thenProceed() throws Throwable {
        ...
        Object result = aspect.check(point, annotation());
    ...
    @Test
    @DisplayName("REQ-AUTH-001：账号禁用时即使拥有权限也返回 403")
    void check_whenUserDisabled_thenThrows() {
        CurrentUserHolder.set(new CurrentUser(1L, Set.of("admin"), Set.of("report:create"), "disabled"));
        ProceedingJoinPoint point = mock(ProceedingJoinPoint.class);
    ...
    private RequiresPermission annotation() {
        try {
