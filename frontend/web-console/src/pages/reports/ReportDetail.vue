<template>
  <section class="page report-detail-page">
    ...
    <section class="export-panel">
      ...
      <el-form label-position="top" class="brand-form">
        ...
        <el-form-item label="模板编码">
          <el-input v-model="form.templateId" aria-label="模板编码" />
        </el-form-item>
        <el-form-item label="企业名称">
          <el-input v-model="form.brand.companyName" aria-label="企业名称" />
        </el-form-item>
        <el-form-item label="标识对象键">
          <el-input v-model="form.brand.logoObjectKey" aria-label="标识对象键" />
        </el-form-item>
      ...
      <div v-if="selectedManagedTemplate" class="managed-template-preview" aria-label="已治理企业模板快照">
        ...
        <span>版本 {{ selectedManagedTemplate.version }}</span>
      ...
      <el-col :span="8">
        ...
        <el-card shadow="never" class="collaboration-panel">
          ...
          <el-form label-position="top" class="comment-form">
            ...
            <el-form-item label="指派用户编号">
              <el-input v-model="commentForm.assigneeUserId" aria-label="指派用户编号" placeholder="例如 1001" />
            </el-form-item>
        ...
        <el-card shadow="never" class="share-panel">
          ...
          <div v-if="activeShare" class="share-result">
            <p>状态：{{ shareStatusLabel(activeShare.status) }}</p>
    ...
    <el-card shadow="never" class="version-panel">
      ...
      <el-table :data="versions" class="version-table" empty-text="暂无版本数据">
